...
let ChatsGateway = class ChatsGateway {
    ...
    async create(createChatDto) {
        ...
        this.server.emit('mensagem_' + createChatDto.destinatarioID.toString(), mensagem);
    }
    async findHistory(body) {
        const { remetenteId, destinatarioId } = body;
        const historico = await this.chatsService.findHistory(remetenteId, destinatarioId);
        this.server.emit(`historico_${body.remetenteId}_${body.destinatarioId}`, historico);
    }
...
__decorate([
    (0, websockets_1.SubscribeMessage)('novaMensagen'),
...
__decorate([
    (0, websockets_1.SubscribeMessage)('findHistory'),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ChatsGateway.prototype, "findHistory", null);
__decorate([
